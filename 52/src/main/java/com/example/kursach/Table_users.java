...
public class Table_users {
    ...
    public Table_users(String id, String name, String surname, String patronymic, String gender, String dilution_date, String login, String password, String passport_date, String phone, String mail, String role) {
        this.id = id;
        this.name = name;
        this.surname = surname;
        this.patronymic = patronymic;
